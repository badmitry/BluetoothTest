...
import com.badmitry.bluetoothtest.BluetoothLeService.LocalBinder
import java.util.*
...
//    }
    ...
    private fun displayGattServices(gattServices: List<BluetoothGattService>?) {
        ...
        if (sensorManager.getDefaultSensor(Sensor.TYPE_HEART_BEAT) != null) {
            ...
            Log.d(TAG, "sensorManager TYPE_HEART_BEAT sukcess")
        } else {
            Log.d(TAG, "sensorManager TYPE_HEART_BEAT fail")
        }
        if (sensorManager.getDefaultSensor(Sensor.TYPE_HEART_RATE) != null) {
            Log.d(TAG, "sensorManager TYPE_HEART_RATE sukcess")
        } else {
            Log.d(TAG, "sensorManager TYPE_HEART_RATE fail")
        }

        if (sensorManager.getDefaultSensor(Sensor.TYPE_GYROSCOPE) != null) {
            Log.d(TAG, "sensorManager TYPE_GYROSCOPE sukcess")
        } else {
            Log.d(TAG, "sensorManager TYPE_GYROSCOPE fail")
        }
        // Loops through available GATT Services.
        for (gattService in gattServices) {
            gattService.describeContents()
...
//            Log.d(TAG, "HEART_RATE_MEASUREMENT" + SampleGattAttributes.HEART_RATE_MEASUREMENT)
            for (gattCharacteristic in gattCharacteristics) {
                ...
                Log.d(
                    TAG,
                    "gattService.gattCharacteristic.characteristics" + gattCharacteristic.uuid
                )
        ...
        val gattServiceAdapter = SimpleExpandableListAdapter(
            ...
            intArrayOf(R.id.device_name, R.id.device_address),
